package com.example.w12_209410314;
...
public class MainActivity extends AppCompatActivity implements
    ...
    TextView rr; Button bt_pau, bt_st; CheckBox ck; MediaPlayer mp; Uri u, u_v; VideoView vv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rr.setText(getString(R.string.play)+ss); prep();
        Log.d("test","after pre()");
//        bt_pau.setOnClickListener(this);
//        bt_st.setOnClickListener(this);
        ...
        try{
            ...
            vv.start();
            //Toast.makeText(this,""+vv.getCurrentPosition()+)
        } catch (Exception e){
            Toast.makeText(this,getString(R.string.err), Toast.LENGTH_SHORT).show();
        }
    }
...
//           vv.getCurrentPosition(); vv.setcurr;vv.seekTo(0); vv.start();
        ...
        if(view == bt_st){
//            mp.pause(); mp.seekTo(0); bt_pau.setText(getString(R.string.pl));
//            bt_st.setEnabled(false);
            onPause();
        }
        if(ck == view){
    ...
    void prep() {
        bt_pau.setText(getString(R.string.pl));
        bt_pau.setEnabled(false); bt_st.setEnabled(false);
        try{
            mp.reset(); mp.setDataSource(this, u); mp.setLooping(ck.isChecked());
            mp.prepareAsync();
        } catch (Exception e){
            Toast.makeText(this,getString(R.string.err),
